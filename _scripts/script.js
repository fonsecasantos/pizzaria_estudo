...
$('section#plano-principal').waypoint( function (direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(0)').removeClass('animate__animated animate__fadeOutLeft');
        $('div.planos:eq(1)').removeClass('animate__animated animate__fadeOutUp animate__slow');
        $('div.planos:eq(2)').removeClass('animate__animated animate__fadeOutRight');
        ...
        $('div.planos:eq(0)').addClass('animate__animated animate__fadeOutLeft');
        $('div.planos:eq(1)').addClass('animate__animated animate__fadeOutUp animate__slow');
        $('div.planos:eq(2)').addClass('animate__animated animate__fadeOutRight');    
    }
}, {
    offset:'400px;'
})
